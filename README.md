...
这是基于[Shiro](https://github.com/MisakaTAT/Shiro/) 的QQ机器人，做得不怎么好，基本上是自娱自乐性质的产物。
...
另外此项目也使用了来自 [spring-mirai-server](https://github.com/protobufbot/spring-mirai-server) 仓库的代码
